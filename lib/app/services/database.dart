...
class Database {
  ...
  static Stream<QuerySnapshot<Map<String, dynamic>>>readSalesProduct({required String idAccount}) =>FirebaseFirestore.instance.collection('ACCOUNTS/$idAccount/CATALOGUE').orderBy("sales", descending: true).limit(20).snapshots();
