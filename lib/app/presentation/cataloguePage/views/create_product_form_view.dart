    ...
    return AppBar(
      ...
      bottom: controller.getDataUploadStatus
          ? PreferredSize(
              ...
              child: ComponentApp()
                  .linearProgressBarApp(color: controller.colorLoading))
          : PreferredSize(
              preferredSize: const Size.fromHeight(4),
          ...
          children: [
            ...
            Center(
              child: TextButton(
                  onPressed: controller.getDataUploadStatus
                      ? null
                      : controller.getCurrentSlide == 8 ? controller.getUserConsent? controller.save : null: () => controller.next(),
                  child: Text(
                      controller.getCurrentSlide == 8 ? 'Publicar' : 'Siguiente')),
            ),
          ],
        )
      ],
          ...
          onPageChanged: (index, reason) {
            ...
            switch (index) {
              case 0: // seleccion de una imagen para el producto
                ...
                break;
              case 1: // descripcion
                controller.descriptionTextFormFieldfocus
                    .requestFocus(); // pide el foco
                break;
              case 2: // marca
                FocusScope.of(context).unfocus(); // quita el foco
                break;
              ...
              case 4: // precio de compra
                controller.purchasePriceTextFormFieldfocus
                    .requestFocus(); // pide el foco
                break;
              case 5: // precio de venta al publico
                controller.salePriceTextFormFieldfocus
                    .requestFocus(); //  pide el foco
                break;
              default:
                FocusScope.of(context).previousFocus(); // quita el foco
        ...
        child: Form(
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              labelText: controller.controllerTextEditMark.text == ''
                  ? 'Seleccionar marca'
                  : 'Marca',
              helperText: 'Visibilidad pública',
            ),
          ...
          onChanged: (value) {
            if (controller.controllerTextEditPrecioCosto.numberValue != 0) {
              controller.setPurchasePrice =
                  controller.controllerTextEditPrecioCosto.numberValue;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          controller.getPorcentage == '' || controller.getCurrentSlide != 5
              ? Container()
              : Padding(
                  ...
                  child: Form(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) => controller.setQuantityStock =
                          int.parse(
                              controller.controllerTextEditQuantityStock.text),
                      decoration: const InputDecoration(
                        filled: true,
                      ...
                      validator: (value) {
                        if (int.parse(controller
                                .controllerTextEditQuantityStock.text) ==
                            0) {
    ...
    return ListView(
      children: [
        ...
        AnimatedContainer(
          ...
          child: const Text(
              '¡Gracias por hacer que esta aplicación sea aún más útil para más personas! 🚀'),
        ),
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          disabledBorder: UnderlineInputBorder(
            ...
            color: stateEdit ? borderColor : Colors.transparent,
          )),
          labelText: labelText,
        ),
      ),
